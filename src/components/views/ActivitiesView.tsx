...
import ViewToggle, { type ViewOption } from "@/components/common/ViewToggle";
...
// View options for the toggle including calendar
...
export default function ActivitiesView() {
  ...
  const queryParams = useMemo(() => ({
    ...
    // For calendar view, fetch a wider date range (current month +/- 1 month buffer)
    ...(isCalendar
      ? {
      ...
      : {}),
  }), [activeTab, needsPlanFilter, hasUnlinkedFilter, isCalendar, calendarDate]);
  ...
  return (
    <div className={`h-full overflow-auto bg-[#FFFCFA] ${isCalendar ? "flex flex-col" : ""}`}>
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4">
        <div className={`${isCalendar ? "" : "max-w-6xl mx-auto"} flex items-center justify-between`}>
          <div>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className={`${isCalendar ? "" : "max-w-6xl mx-auto"} px-6`}>
      ...
      {/* Filters Row (hidden in calendar view since calendar has its own controls) */}
      {!isCalendar && (
        <div className="bg-white border-b border-gray-200">
