...
describe("GridPager", () => {
  it("shows the 1-based row range and total on the first page", () => {
    render(<GridPager total={738} page={1} pageSize={50} onPageChange={vi.fn()} onPageSizeChange={vi.fn()} />);
    expect(screen.getByText("Showing 1–50 of 738")).toBeInTheDocument();
  });

  it("shows the correct range on an interior page", () => {
    render(<GridPager total={738} page={3} pageSize={50} onPageChange={vi.fn()} onPageSizeChange={vi.fn()} />);
  ...
  it("disables Next on the last page and enables Previous", () => {
    render(<GridPager total={738} page={15} pageSize={50} onPageChange={vi.fn()} onPageSizeChange={vi.fn()} />);
  ...
  it("advances to the next page when Next is clicked", () => {
    ...
    render(<GridPager total={738} page={1} pageSize={50} onPageChange={onPageChange} onPageSizeChange={vi.fn()} />);
  ...
  it("goes back a page when Previous is clicked", () => {
    const onPageChange = vi.fn();
    render(<GridPager total={738} page={3} pageSize={50} onPageChange={onPageChange} onPageSizeChange={vi.fn()} />);
  ...
  it("reflects the current page as the dropdown's selected value", () => {
    render(<GridPager total={738} page={7} pageSize={50} onPageChange={vi.fn()} onPageSizeChange={vi.fn()} />);
  ...
  it("renders the rows-per-page selector with all five options", () => {
    render(
      <GridPager
        total={738}
        page={1}
    ...
    expect(options.map((o) => o.textContent)).toEqual(["50", "100", "200", "500", "1000"]);
  });

  it("calls onPageSizeChange with the selected number", () => {
