...
const SUB_SCORES = [
  ...
  },
  {
    ...
    factors: [
      ...
      { name: "Existing Vendor Revenue", points: "0-25", metric: "Lifetime total revenue across all 5 vendors (Fullmind, Elevate, Proximity, TBT, Educere) from VendorFinancials + CompetitorSpend tables.", finding: "Districts already spending on virtual instruction are proven buyers with established procurement paths." },
  ...
  },
  {
    ...
    factors: [
      ...
      { name: "Existing Competitor Spend", points: "0-20", metric: "Count of distinct vendors with revenue > $0 across all 5 vendors, from VendorFinancials + CompetitorSpend (GovSpend PO data).", finding: "The strongest behavioral signal. Multi-vendor districts spend 7.3x more on average ($772K vs $106K). If they're buying virtual instruction from anyone, they're a proven market participant." },
  ...
  },
  {
    ...
    factors: [
      ...
      { name: "Existing Penetration", points: "0-25", metric: "% of districts in the state with any vendor revenue, computed from VendorFinancials + CompetitorSpend.", finding: "Higher penetration means a proven sales motion, reference customers, and market awareness. SC leads at 34.1%." },
      { name: "Existing Revenue in State", points: "0-15", metric: "Total lifetime vendor revenue from all districts in the state, from VendorFinancials + CompetitorSpend.", finding: "Higher existing revenue signals proven demand and referenceable customers." },
      { name: "Churn Penalty", points: "0 to -15", metric: "Blended customer churn (30% weight) and revenue churn (70% weight) computed from Fullmind + Elevate K12 vendor_financials, comparing FY24-25 customers to FY26-27 retention.", finding: "Penalizes states where the sales motion may be broken despite historical success. E.g., SC lost $20M in revenue (78.5% rev churn) despite retaining 14 of 30 customers. States with no FM/EK12 presence are unaffected." },
    ],
  },
];
