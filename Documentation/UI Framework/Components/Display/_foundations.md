...
File: "Mapomatic Design System" → Page: "Components" → Artboard: "Display" (ID: `293-1`)

Use `mcp__paper__get_screenshot(nodeId: "293-1")` for a visual overview, or `mcp__paper__get_children(nodeId: "293-1")` to browse individual sections.
