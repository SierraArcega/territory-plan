...
LEFT JOIN user_profiles owo ON d.owner_id = owo.id
...
CREATE INDEX idx_dmf_sales_exec ON district_map_features(sales_executive_id);
CREATE INDEX idx_dmf_owner ON district_map_features(owner_id);
